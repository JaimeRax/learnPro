...
<html lang="en">
    ...
    text-align: center;
    padding-top: 8px;
    font-weight: normal; /* Esto asegura que el texto no esté en negrita */
}
        ...
        @foreach ($payments as $dato)
            ...
            <div style="flex-direction: column;">
                ...
                <div style="flex-direction:row; margin-top: 1px;">
                    ...
                    <span class="content" style="width:37% ">Primero</span>
                    <span class="campo" style="font-size: 0.8rem; margin-left: 35.3px;">Secciòn: </span>
                ...
                <div style="flex-direction:row; margin-top: 1px;">
                    ...
                    <span class="content" style="width:35.8%"> Mensualidad </span>
                </div>

                <div style="flex-direction:row; margin-top: 10px;">

                    <span class="campo" style=" font-size: 0.8rem;"> Observaciones</span>
                    <span class="content" style="width:84.2%; font-size: 0.8rem;"> jhbjkhbhbkhbjk jsdnkljfa jansdlfk jas jnksdf </span>
                </div>
                ...
                <div style="flex-direction:row; margin-top: 10px;">
                    ...
                    <span class="" style="width:94.5%; font-size: 0.7rem;"> Q. {{ $dato->personal_code }} </span>
                </div>
