...
@section('main')
    @auth
        <div class="flex flex-col items-center justify-center h-screen bg-white">
            ...
            <div class="flex flex-row items-stretch justify-center space-x-8">
                ...
                <div class="max-w-xs p-8 text-sm text-justify rounded-lg shadow-lg w-80 bg-gray-50 h-96">
                    ...
                    <h2>Ser una Institución Educativa líder de la región, en la formación académica de excelencia, con
                        principios y
                        valores para alcanzar una educación sólida que ayude al estudiante a desarrollarse como ciudadano útil,
                        en
