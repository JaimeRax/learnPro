<div class="p-4 md:p-5">
    ...
    @endforeach
        ...
        <input id="name{{ $student->id }}" name="name" class="w-full shadow-sm input" readonly type="text"
        ...
        <input name="bank" class="hidden w-full shadow-sm input" readonly type="text" value="Ninguno">


        <input name="document_number" class="hidden w-full shadow-sm input" readonly type="text" value="12345678">
        ...
        <div class="flex items-center space-x-4">
            <div id="grade_id_{{ $student->id }}">
                <x-inputs.general id="grade_id_{{ $student->id }}" name="degree_id"
                    value="{{ $student->degree->name }}" required />
            </div>

            <div id="section_id_{{ $student->id }}">
                <x-inputs.general id="section_id_{{ $student->id }}" name="section_id"
                    value="{{ $student->section->name }}" required />
            </div>
        </div>
        ...
        <div id="meses-pago_{{ $student->id }}">
            <div class="tw-grid tw-grid-cols-5 tw-gap-6">
                ...
                <label class="ml-5 cursor-pointer tw-label">
                    ...
                    <input type="checkbox" name="month" id="enero" value="enero" id="mes_1_{{ $student->id }}" class="tw-checkbox">
                </label>
        ...
        {{-- TOTAL --}}
        <div class="flex items-center space-x-4">
            <x-inputs.general id="amount" titulo="Total" name="amount"
                value="0" />
        </div>
        ...
        <a id="createPayment-{{ $studens->id }}" href="{{ url('payments/pdf_generator', $studens->id) }}"
