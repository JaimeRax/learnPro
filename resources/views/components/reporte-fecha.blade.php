<x-button class="shadow-sm bg-base-100 hover:bg-base-300">

    <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 32 32">

    <defs>

    <linearGradient id="IconifyId190394e5b9397397b1" x1="4.494" x2="13.832" y1="-2092.086" y2="-2075.914"
    ...
    <path fill="url(#IconifyId190394e5b9397397b1)"
