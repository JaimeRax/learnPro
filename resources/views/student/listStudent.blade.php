...
@section('main')
    <div class="grid grid-cols-1 gap-2">
        ...
        <div class="grid items-center justify-center grid-cols-1 gap-2 md:grid-cols-3 lg:flex">
            ...
            <form method="GET" action="/courses" id="degreeForm" class="">
                <x-inputs.select-option id="degree_id" titulo="" name="degree_id" />
            </form>

            <x-button-link href="student/new" class="btn-primary">
